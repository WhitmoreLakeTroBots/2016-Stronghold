...
public class CMDautoTerrain extends CommandGroup {
	...
	public CMDautoTerrain(int startingPosition) {
				...
				addSequential (new CMDdriveForward(Settings.Auto_InchesToDefenseTerrian + Settings.Auto_InchesToCrossDefenseTerrian
				...
				addSequential (new CMDdriveForward(Settings.Auto_Position2and4InchesToScore, Settings.Auto_Position2TurnHeading,  Settings.Auto_DriveSpeed));
