 ...
 *
 */
public class CMDdriveBackward extends Command {
	boolean _isFinished;
	double _Distance;
	double _gyroAngle;
	...
	public CMDdriveBackward(double Distance, int CommandedHeading, double Speed) {
		_Distance = Distance;
	...
	protected void initialize() {
		...
		_isFinished = false;
		System.out.println("Initial Distance  " + _Distance);
