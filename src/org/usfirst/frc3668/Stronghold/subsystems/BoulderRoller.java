...
public class BoulderRoller extends Subsystem {
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new CMDrollerForward());
    ...
    public void rollForward(JoystickButton rollerForward){
    	if(rollerForward.get()){
    ...
    public void rollBackward(JoystickButton rollerBackward){
    	if(rollerBackward.get()){
